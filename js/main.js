...
let Jx_now = new Date(); 
function createtime() {
  var grt= new Date("02/15/2019 17:38:00");//建站时间2019.02.15
  Jx_now.setTime(Jx_now.getTime()+250); 
  days = (Jx_now - grt ) / 1000 / 60 / 60 / 24; dnum = Math.floor(days); 
  hours = (Jx_now - grt ) / 1000 / 60 / 60 - (24 * dnum); hnum = Math.floor(hours); 
  if(String(hnum).length ==1 ){hnum = "0" + hnum;} minutes = (Jx_now - grt ) / 1000 /60 - (24 * 60 * dnum) - (60 * hnum); 
  mnum = Math.floor(minutes); if(String(mnum).length ==1 ){mnum = "0" + mnum;} 
  seconds = (Jx_now - grt ) / 1000 - (24 * 60 * 60 * dnum) - (60 * 60 * hnum) - (60 * mnum); 
